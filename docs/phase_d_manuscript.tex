...
free parameter. Third, the framework generates three falsifiable predictions
(P1, P2, P3) that can be tested numerically or experimentally to distinguish
the correspondence from alternative graph-curvature-to-quantum-dissipation
mappings.
...
to arbitrary 2-local jump operators, and incorporate detailed balance to
pin down the bath-temperature identification.
