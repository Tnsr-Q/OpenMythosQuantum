...
if fallback_status == DEGRADED: final_score_i = final_score_i - DEGRADED_STATUS_PENALTY
```
...
```text
final_score_i = w_cost*cost_score_i + w_latency*latency_score_i + w_fidelity*fidelity_effective_i + w_region*region_score_i
```
